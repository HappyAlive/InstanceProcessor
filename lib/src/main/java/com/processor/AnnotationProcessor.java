...
//        types.add(Utils.sClassName);
        types.add(NewInstance.class.getName());
//        types.add(Override.class.getCanonicalName());
//        types.add("com.shentu.factory.ui.main.InstanceFactory");
//        types.add("com.common.base.InstanceFactory");
